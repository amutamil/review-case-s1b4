...
namespace ColumnFilter
{
	...
	bool IsColumnNumberCorrect(vector <vector<string>> csvFileArray, string colNum);
	bool IsStringIsValidForStoi(string str);
	bool IsStringIsValid(string str);
	bool IsColumnNumberWithinLimit(vector <vector<string>> csvFileArray, int colNum);
